...
const Carousel = ({
  ...
  const nextSlide = () => {
    if (isTransitioning || currentIndex === 3) {return;}
  ...
  return (
    <div className="carousel-list-header">
      ...
      <div className="carousel-container">
        {currentIndex !== 0 && (
          <button onClick={prevSlide} className="carousel-nav-button carousel-prev">
            <BackButton />
          </button>
        )}
        <div className="carousel-viewport">
          <div className="carousel-image-wrapper" ref={carouselRef}>
            {showImages()}
          </div>
        </div>
        {currentIndex !== 3 && (
          <button onClick={nextSlide} className="carousel-nav-button carousel-next">
            <NextButton />
          </button>
        )}
      </div>
